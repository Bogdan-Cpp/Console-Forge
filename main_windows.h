    ...
    do {
      ...
      if (command.length() >= 1) {
          ...
          //yt
              ...
              ShellExecute(0, "open", "https://www.youtube.com", NULL, NULL, SW_SHOW);
          }

          //google suite
          else if (command == "mail" || command == "gmail") {
              ShellExecute(0, "open", "https://mail.google.com/mail/u/0/#inbox", NULL, NULL, SW_SHOW);
          }
          else if (command == "mp") {
              ShellExecute(0, "open", "https://www.google.com/maps/", NULL, NULL, SW_SHOW);
          }
          else if (command == "gem" || command == "gemini" || command == "gm") {
              ShellExecute(0, "open", "https://gemini.google.com/", NULL, NULL, SW_SHOW);
          }
          else if (command == "d" || command == "dr" || command == "drive" || command == "drv") {
              ShellExecute(0, "open", "https://drive.google.com/drive/home", NULL, NULL, SW_SHOW);
          }
          else if (command == "tr" || command == "trans" || command == "translate") {
              ShellExecute(0, "open", "https://translate.google.com/", NULL, NULL, SW_SHOW);
          }

          //google office
          else if (command == "docs" || command == "gd") {
              ShellExecute(0, "open", "https://docs.google.com/", NULL, NULL, SW_SHOW);
          }
          ...
          //others
              ...
              ShellExecute(0, "open", "https://web.whatsapp.com/", NULL, NULL, SW_SHOW);
          }
          else if (command == "nt" || command == "notion" || command == "not") {
              ShellExecute(0, "open", "https://www.notion.so/", NULL, NULL, SW_SHOW);
          }
          else if (command == "gh" || command == "github") {
              ShellExecute(0, "open", "https://github.com/", NULL, NULL, SW_SHOW);
          }

          else if (command == "lt" || command == "leetcode") {
              ShellExecute(0, "open", "https://leetcode.com/", NULL, NULL, SW_SHOW);
          }

          else if (command == "ai" || command == "chatgpt") {
              ShellExecute(0, "open", "https://www.chatgpt.com", NULL, NULL, SW_SHOW);
          }
      }
    } while(command != "exit");
